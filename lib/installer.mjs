...
const SCRIPTS = [
  ...
  { src: 'scripts/trace-path.mjs', dest: '.claude/scripts/trace-path.mjs' },
  { src: 'scripts/guard-repeat-commands.mjs', dest: '.claude/scripts/guard-repeat-commands.mjs' },
  ...
  { src: 'scripts/check-migration-drift.mjs', dest: '.claude/scripts/check-migration-drift.mjs' },
  { src: 'scripts/start-dev-server.mjs', dest: '.claude/scripts/start-dev-server.mjs' },
  { src: 'scripts/clean-run-artifacts.mjs', dest: '.claude/scripts/clean-run-artifacts.mjs' },
];
