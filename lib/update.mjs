...
const FILE_MAP = {
  ...
  '.claude/scripts/trace-path.mjs': 'scripts/trace-path.mjs',
  '.claude/scripts/guard-repeat-commands.mjs': 'scripts/guard-repeat-commands.mjs',
  ...
  '.claude/scripts/clean-run-artifacts.mjs': 'scripts/clean-run-artifacts.mjs',
};
